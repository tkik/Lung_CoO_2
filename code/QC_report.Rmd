...
annotation <- read.delim(file="/C010-projects/Reka/33_CoO_lung/CoO_Lung_Cancer/data/annotation_table_TAGWGBS_24_2.txt",stringsAsFactors = F)
...
save.image(file="/C010-projects/Reka/33_CoO_lung/CoO_Lung_Cancer/data/QC_data.RData")
...
load(file="Z:/Reka/33_CoO_lung/data/QC_data.RData")
